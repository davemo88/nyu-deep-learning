...
Following loosely the example of several papers, we built a stacked CAE that was trained to minimize reconstruction error. In \autocite{app:A}, the full model architecture is given verbatim. Our architecture was based on two building blocks:
\begin{itemize}
...
\appendix
\section{Stacked CAE Architecture}
\begin{verbatim}
nn.Sequential {
  [input -> (1) -> (2) -> (3) -> output]
  (1): nn.Sequential {
...
\end{verbatim}
>>>>>>> 18a87681bf19a4c53c1c83c4f94e4110a227d6b4
\end{document}
