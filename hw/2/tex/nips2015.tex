...
Our final model used only supervised training as our attempts to leverage the unlabeled data were not entirely successful. However working with the unlabaled data did inspire the architecture of our final model which achieved a modest $\sim70\%$ accuracy (see \autoref{app:A}).
