...
\end{align*}
\section{Torch}
MNIST is a public database of images of handwritten digits, commonly used for benchmarking of image recognition algorithms. In this assignment we apply several CNNs to the multiclass classification problem of assigning the correct label (0-9) to each image.
