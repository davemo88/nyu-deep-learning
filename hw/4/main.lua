...
local params = {
                ...
                max_epoch=3,  -- when to start decaying learning rate
                max_max_epoch=5, -- final epoch
                max_grad_norm=4.5 -- clip when gradients exceed this norm value
               }
...
while epoch < params.max_max_epoch do
    ...
    if step % epoch_size == 0 then
        ...
        torch.save('/home/dk2353/model2_' .. epoch .. '.t7b', model)
    end
end
run_test()
-- torch.save('/home/dk2353/model_' .. epoch .. '.t7b', model)
